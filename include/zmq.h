...
#define ZMQ_SHM_IPC_FILTER_PID 61
#define ZMQ_SHM_IPC_FILTER_UID 62
#define ZMQ_SHM_IPC_FILTER_GID 63
#define ZMQ_CONNECT_RID 64
#define ZMQ_SHM_BUFFER_SIZE 65
